...
public class OficeEditorMgrTest {
    ...
    @Test@Title("Тест на редактировании офиса")
    public void oficeeEditorMgrTest() throws Exception{
        steps.addPromoMysql();
        carcas.go_to_office_editor();
        front.hotOffersEdit();
        front.promoEdit();
        front.saveEditorForm();
        steps.waitABit(8000);
    }
