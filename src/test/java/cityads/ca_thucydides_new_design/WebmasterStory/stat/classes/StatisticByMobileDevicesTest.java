...
public class StatisticByMobileDevicesTest {
    ...
    @Test@Pending
    public void statisticByAuditoryByMobileDevicesTest() throws Exception{

        front.login();
        carcas.go_to_statistic_by_auditory_by_devices_byMobileDevices();
