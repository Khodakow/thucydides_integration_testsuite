...
public class OffersMonitoringTop5StoryTest extends Constants {
...
/*      return Arrays.asList(new Object[][]{
    ...
    public OffersMonitoringTop5StoryTest(String offerName) {
    ...
    public  void offers_monitoring_data_top5_indicators() throws Exception {
