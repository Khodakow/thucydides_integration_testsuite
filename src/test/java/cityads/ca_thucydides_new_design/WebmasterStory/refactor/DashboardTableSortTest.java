...
public class DashboardTableSortTest {
    ...
    public void dashboardTableSortStoryTest() throws Exception{
        ...
        table.check_column_sort_ascend(7, "Ranking");
        table.check_column_sort_ascend(8, "7D eCPC");
        table.check_column_sort_ascend(9, "3M eCPC");
