...
public class CampaignsMobileTranslateEspStoryTest {
   ...
   @Test
   @Title("Мобильные офферы Esp  переводы")
   @WithTagValuesOf({"block:Traslation","role:Webmaster"})
    public void checkMobileCampaignsEspTranslation(){
    String wmName = ss.get_wm_name();
    os.wm_login(wmName);
    os.change_lang_to_es();
