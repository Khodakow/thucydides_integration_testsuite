...
@Concurrent
public class GoodsPopUpTranslateEspStoryTest {
    ...
    public void test_goods_PopUp_regions_Esp_TranslateStoryTest()throws Exception{
    ...
    @Test @WithTagValuesOf({"block:Goods And Coupons", "role:Webmaster"}) 
    public void test_goods_PopUp_categories_esp_TranslateStoryTest()throws Exception{
    ...
    public void test_goods_PopUp_offers_esp_TranslateStoryTest()throws Exception{
