...
public class ToolsTranslateEspStoryTest {
   ...
   @Test
   @Title("Инструменты esp переводы")
   @WithTagValuesOf({"block:Traslation","role:Webmaster"})
    public void checkToolsEspTranslation(){
    ...
    @Test
    @Title("Текс шифт esp переводы")
    @WithTagValuesOf({"block:Traslation","role:Webmaster"})
    public void checkTextShiftMainPageEspTranslation(){
        String wmName = steps.get_wm_name();
        steps.wm_login(wmName);
        steps.wait_for_all_spinners_dissapears(30);
