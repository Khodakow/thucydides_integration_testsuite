...
public class TextShiftCreateToolTranslateEspStoryTest {
    ...
    @Test
    @Title("создание текстшифта  esp переводы")
    public void checkToolsCreationEspTextshiftTranslation(){
    ...
    @Test
    @Title("Тест на перводы esp Text Shift в части popup из таблицы")
    public void checkToolsCreatedEspTextshiftTranslation(){
    ...
    @Test
    public void checkToolsCreatedEspExtensionCodeEspPopupTextshiftTranslation(){
        String name = DataGenerator.getRandomNameWithDate();
        String subacc = DataGenerator.getRandomNameWithDate();
