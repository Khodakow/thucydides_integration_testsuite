...
public class GetLinkTranslateStoryTest {
    ...
    @Title("Гетлинк переводы попап")
    public void getLinkPopupTranslation(){
        form.create_form();
    ...
    @Test
    @WithTagValuesOf({"block:Traslation","role:Webmaster"})
    @Title("Гетлинк переводы создание")
    public void getLinkCreateTranslation(){
        form.create_form();
    ...
    @Test
    @WithTagValuesOf({"block:Traslation","role:Webmaster"})
    @Title("Гетлинк переводы таблица")
    public void getLinkTranslation(){
        steps.check_lang_select();
    }
