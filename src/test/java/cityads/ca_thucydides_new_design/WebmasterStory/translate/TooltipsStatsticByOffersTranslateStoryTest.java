...
public class TooltipsStatsticByOffersTranslateStoryTest extends Constants {
   ...
   @WithTagValuesOf({"block:Traslation","role:Webmaster"})
    public void check_statistic_by_offers_tooltips_translate(){
/*    String wmName = steps.get_wm_name();
    steps.wm_login(wmName);
    steps.click_statistic_link();
    steps.wait_for_all_spinners_dissapears(60);
    steps.click_conversions_stat_link();
    steps.wait_for_all_spinners_dissapears(30);
    steps.click_byoffers_main_link();
    steps.click_byoffers_not_realtime_link();
    steps.wait_for_all_spinners_dissapears(60);
